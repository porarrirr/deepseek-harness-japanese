...
export const ja: Record<AgentPresetSettingsKey, string> = {
  title: 'エージェントプリセット',
  description: 'これから開始するセッションに適用されます。実行中のセッションは開始時のプリセットを使い続けます。',
  loading: 'プリセットを読み込み中…',
  error: 'エージェントプリセットを読み込めません。',
  userTrust: 'カスタム',
  seatHint: 'これから開始するセッションのエージェントプリセット',
  headerHint: 'このセッションが実行するエージェントプリセット（開始時に固定）',
  nav: 'エージェントプリセット',
  sectionIntro: 'プリセットは、1 つのセッションのエージェントが実行するプラグイン構成（ツール、プロンプト、機能）です。既存のものを複製して自分用にするか、Creator モードでエージェントに作成させることができます。',
  builtIn: '組み込み',
  setDefault: 'デフォルトに設定',
  view: '表示',
  presetStandardName: '標準モード',
  presetStandardDescription: 'ファイル編集、シェル、ファイルとウェブ検索、スキル、計画、目標、サブエージェント、ワークフローに対応する完全なコーディングエージェント。',
  presetCodeName: 'PTC モード',
  presetCodeDescription: '標準モードのすべての機能に加え、Code Mode SDK を通じてツールを公開し、モデルが 1 つの TypeScript プログラムで複数の操作を組み合わせられます。',
  presetMinimalName: '最小モード',
  presetMinimalDescription: '永続 bash と str_replace_editor の 2 ツールを備えたコーディングエージェント。',
  presetCordisName: 'Creator モード',
  presetCordisDescription: 'カスタムエージェントプリセットの作成向け。標準モードのすべての機能に加え、ランタイム検査、プラグイン実験、プリセット作成ガイドを提供します。',
  duplicate: '複製',
  ...
  presetIdPlaceholder: 'my-agent',
  displayName: '名前',
  displayNamePlaceholder: 'ピッカーに表示する名前。空欄の場合は識別子を使います',
  inUse: '使用中',
  builtInGroup: '組み込み',
  customGroup: 'カスタム',
  noDescription: '説明なし。',
  ...
  retry: '再試行',
  copyTitle: 'プリセットを複製',
  copyIntro: 'プリセット全体をこのマシンに複製します。識別子はディレクトリ名になり、後から変更できません。それ以外はプリセット自身のファイルで編集します。',
  create: '作成',
  creating: '作成中…',
  creatorDraft: 'Creator モードでカスタムプリセットを作成',
  openLocation: 'フォルダーを開く',
  showLocation: '場所を表示',
  revealedPathLabel: 'プリセットファイル：',
  idRequired: 'プリセットの識別子を入力してください。',
  idInvalid: '小文字、数字、ハイフンを使い、先頭は英字または数字にしてください。',
  idTaken: 'この識別子のプリセットはすでに存在します。',
  deleteTitle: 'このプリセットを削除しますか？',
  deleteDescription: 'プリセットディレクトリを削除します。実行中のセッションは動作を続けますが、新しいセッションでは選択できなくなります。',
  deleteConfirm: '削除',
  deleting: '削除中…',
}
