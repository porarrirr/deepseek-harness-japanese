...
describe('invariant companion', () => {
  ...
  it('client apply provides ctx.locale seeded with the three-language common namespace', async () => {
    ...
    expect(() => (locale as LocaleRuntime).register(COMMON_NS, 'ja', {})).toThrow('already has locale')
  })
})
