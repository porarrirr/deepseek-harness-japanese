...
export const ja = {
  ...
  'run.superseded': '新しい実行カードを以下で確認してください',
  'panel.hint': '実行コントロールは Settings 上部の Cordis パネルにあります',
  ...
  'render.failedAbdicated': '{slot} のレンダリングに失敗しました。デフォルト UI に戻しました：',
  'render.failedHeld': '{slot} のレンダリングに失敗しました：',
  'a11y.defining': 'プラグインを定義中',
  'a11y.failed': '定義に失敗',
  'a11y.stopped': '定義を中断',
  'body.source': 'プラグインソース',
  'body.hostCode': 'Host',
  'body.clientCode': 'Client',
  'body.output': '結果',
  'body.copy': 'コピー',
